...
export const TestimonialsSection = () => {
  ...
  const testimonials = [
    { name: "Oriana Delgado", role: "Estudiante Universitaria", avatar: "MG", rating: 5,
    ...
    { name: "Danilo Miranda", role: "Estudiante Universitario", avatar: "CR", rating: 5,
    ...
    { name: "Amadaney Liu", role: "Estudiante Universitaria", avatar: "AL", rating: 4,
    ...
    { name: "Ivan Hernandez", role: "Estudiante Universitario", avatar: "RS", rating: 5,
  ...
  const handleSubmitFeedback = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => setStatus("idle"), 3500); // limpiar mensaje
    }
  };
              ...
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center mt-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className={`h-4 w-4 ${i < t.rating ? "text-accent fill-current" : "text-muted"}`} />
                    ))}
                  </div>
                </div>
              </div>
